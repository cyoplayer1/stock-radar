...
UA_STR += "AppleWebKit/537.36 (KHTML, like Gecko) "
UA_STR += "Chrome/120.0.0.0 Safari/537.36"
...
# === 3. 成交排行函數 (繼承 web_top15.py 邏輯並優化) ===
